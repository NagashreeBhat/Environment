...
public class Sustainability extends AppCompatActivity {
...
//        });
        ...
        Firebase.setAndroidContext(Sustainability.this);
...
//                myNewChild1.setValue(myStringData1);
                ...
                Intent intent = new Intent(Sustainability.this, EnvirontmentFootprint.class);
        ...
        mbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cancel = new Intent(Sustainability.this, EnvirontmentFootprint.class);
