...
//        });
        ...
        Firebase.setAndroidContext(ElectricityUsage.this);
...
//                myNewChild1.setValue(myStringData1);
                ...
                Intent intent = new Intent(ElectricityUsage.this, EnvirontmentFootprint.class);
        ...
        mbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cancel = new Intent(ElectricityUsage.this, EnvirontmentFootprint.class);
