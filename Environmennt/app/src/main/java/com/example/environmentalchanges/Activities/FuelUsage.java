...
public class FuelUsage extends AppCompatActivity {
   ...
   private Button mbtn1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fuel_usage);
...
//        });
        ...
        Firebase.setAndroidContext(FuelUsage.this);
...
//                myStringData11 = mycheck4.getId().toString();
                ...
                Firebase myNewChild = myFirebase.child("Fuel Usage");
...
//                myNewChild1.setValue(myStringData1);
                ...
                Intent intent = new Intent(FuelUsage.this, EnvirontmentFootprint.class);
        ...
        mbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cancel = new Intent(FuelUsage.this, EnvirontmentFootprint.class);
